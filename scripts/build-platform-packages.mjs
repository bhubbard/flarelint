...
const exe = os === "win32" ? "flarelint.exe" : "flarelint";
  ...
  `${JSON.stringify(
    {
      name: `@flarelint/${slug}`,
      version: pkg.version,
      description: `Prebuilt flarelint engine for ${slug}.`,
      license: pkg.license,
...
fs.writeFileSync(
  ...
  `# @flarelint/${slug}\n\n` +
    `Prebuilt \`flarelint\` binary for ${slug}. Installed automatically as an\n` +
    `optional dependency of [\`flarelint\`](https://www.npmjs.com/package/flarelint).\n` +
